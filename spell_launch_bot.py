...
BOTS = {
    ...
    "7": {"slug": "mt5-mcp", "name": "MT5 MCP server",
          "what": "MCP server for MetaTrader 5 — agent reads MT5 data and trades through the terminal.",
    ...
    "14": {"slug": "trading-skills", "name": "Trading Signals (x70.ai)",
           "what": "Free trading-signal feeds for AI agents. Not a bot — read-only signal source.",
           "launch": [], "keyfiles": ["README.md endpoints"], "runnable": False},
    "15": {"slug": "claude-trading-skills", "name": "Claude Trading Skills",
           "what": "67 agent skills for trading (info/data playbooks). Not a bot — a skills library.",
...
QUIZ = [
    ...
    {"q": "Which repo provides free trading-signal feeds for AI agents at signals.x70.ai?", "a": "trading-skills", "hint": "x70"},
    {"q": "Which repo contains 67 agent skills for trading (playbooks/instructions)?", "a": "claude-trading-skills", "hint": "67"},
