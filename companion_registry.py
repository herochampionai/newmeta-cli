...
POKEMONS = [
    ...
    Summon("turtle", "Turtle", "pokemon", "water", "🐢", "The Automation Turtle",
           ...
           house="Hufflepuff"),
    Summon("pikapoke", "Pika Poke", "pokemon", "electric", "🐯", "The Hacker Archon",
           "The permanent Tiger-Lion Hacker Archon — brothers of Pika Turtle from the companion teams. Highly advanced AI developer companion, vault guardian.",
           hook_default="matrix",
